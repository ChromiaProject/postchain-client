...
| merkleHashVersion     | Int                    | 0 (auto-detect)        | Merkle hash version used by the blockchain that the client is connecting to. Possible version is 1 or 2. Value 0 will try to auto-detect the version or fallback to version 1 if auto-detection fails. |
...
| merkle-hash-version  | POSTCHAIN_CLIENT_MERKLE_HASH_VERSION     | 0 (auto-detect)                              | Int                    | See `merkleHashVersion`                                                                                                        |  
